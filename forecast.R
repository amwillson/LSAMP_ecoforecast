...
library(jsonlite)
library('devtools')
library('ncdf4') #covariate
library("reticulate") #covariate
remotes::install_github("eco4cast/neon4cast") #covariate
library('neon4cast') #covariate
neonstore::neon_dir() #covariate

###Covariate

#NEONs Data
# Set working directory
setwd('C:/Users/pceja/Documents/NEON_pressure-air-buoy/')
...
#setting up Covariate for the model
dataATM<- (day_av$Pressure)*0.00986923 #data
forecastATM<- (allpressure)*9.86923e-6 #forecast
forecastMEAN<-apply(forecastATM, 1, mean)  #forecast

cov<-c(dataATM,forecastMEAN) #covariate
